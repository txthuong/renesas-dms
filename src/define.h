...
******************************************/
const static std::string label_list[] = {"CENTER", "DOWN","RIGHT", "LEFT",  "UP"};

/*****************************************
* Static Variables for Alarm Playground
******************************************/
#define ALERT_WAV               "/home/root/sound/wake_up.wav"
#define ATTENTION_WAV           "/home/root/sound/attention.wav"
#define DISTRACT_WAV            "/home/root/sound/distraction.wav"
#define NOT_DETECT_WAV          "/home/root/sound/not_detected.wav"
#define YAWN_WAV                "/home/root/sound/yawning.wav"
...
#define AI_DESC_NAME                "deeppose_cam"
#define ML_DESC_NAME                "rf_gaze_dir.xml"
/*DeepPose Related*/
#define INF_OUT_SIZE                (196)
#define NUM_OUTPUT_KEYPOINT         (98)
#define DEEPPOSE_IN_WIDTH           (256)
#define DEEPPOSE_IN_HEIGHT          (256)
 ...
 *For your information deeppose takes around 125 msec and capture takes around 35 msec. */
...
#define TIME_COEF                   (1)
#define LIPS_YAWN_TIMEOUT           (0.4)
#define HEAD_ROTATE_TIMEOUT         (1.25)
#define EYE_DROW_TIMEOUT            (0.75)
#define EYE_SLEEP_TIMEOUT           (1.25)
#define NO_FACE_TIMEOUT             (2.0)
